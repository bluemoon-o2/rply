...
from rply import ParserGenerator, ParsingError, Token, BoxInt
from rply.errors import ParserGeneratorWarning
from rply.box import SourcePosition

from .base import BaseTests
from .utils import ParserState, RecordingLexer
...
class TestParser(BaseTests):
    ...
    def test_precedence(self):
        ...
        def expr_binop(p):
            return BoxInt({
                "+": operator.add,
                "*": operator.mul
            }[p[1].get_str()](p[0].getint(), p[2].getint()))
    ...
    def test_parse_error(self):
        ...
        assert exc_info.value.get_source_pos().lineno == 10
